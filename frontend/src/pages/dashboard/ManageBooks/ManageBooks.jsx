...
const ManageBooks = () => {
    ...
    const { data, error, isLoading, refetch } = useFetchAllBooksQuery();
    ...
    useEffect(() => {
        if (data) {
            ...
            setBooks(data.books); // Assuming data has a books property
        } else if (error) {
    ...
    if (isError) return <div>Error loading books. Please try again later.</div>;
                        ...
                        <table className="items-center bg-transparent w-full border-collapse">
                            ...
                            <tbody>
                                {books && books.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="5" className="text-center text-gray-500">No books available</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
